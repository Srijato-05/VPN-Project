...
public class ProxyConfig {
    ...
    static {
        try (FileInputStream fis = new FileInputStream(CONFIG_PATH)) {
            ...
            System.err.println("⚠️ Failed to load proxy configuration: " + CONFIG_PATH);
    ...
    public static int getListenPort() {
        try {
            ...
            System.err.println("⚠️ Invalid listenPort value. Using default 8888.");
            return 8888;
        }
    }
    ...
    public static int getForwardPort() {
        try {
            ...
            System.err.println("⚠️ Invalid forwardPort value. Using default 9999.");
            return 9999;
        }
    }
}
